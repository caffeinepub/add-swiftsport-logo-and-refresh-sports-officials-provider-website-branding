...
export class Backend implements backendInterface {
    ...
    async createLeadCaptureRequest(arg0: string, arg1: string, arg2: string, arg3: boolean, arg4: boolean, arg5: boolean, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createLeadCaptureRequest(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllRequests(): Promise<Array<[string, Entry]>> {
        if (this.processError) {
            try {
    ...
    async isSubmitted(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isSubmitted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
